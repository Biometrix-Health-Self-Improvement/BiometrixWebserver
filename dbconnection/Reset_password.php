...
# 
# Reset_password.php
# 	Sends the user an email with a verification link to change their
#	password. The same information is then stored in the file system so that
#	identity can be confirmed and so that it will expire after 24 hours
...
$verify_status = shell_exec ("/var/www/dbconnection/add_reset_token $esc_day $esc_hour $esc_min $esc_token $esc_username $esc_email");
...
$reset_link = "https://www.biometrixapp.com/forgot_password.php?Token=";
$reset_link .= $user_token;

$output = "Please go to the following link and enter your username and new password. ";
$output .= $reset_link;
$output .= " \nPlease note this link is good for only 1 reset.";

#Sends the actual email
mail ($email, "Biometrix password reset requested", $output, $headers);
